        ...
        public static void DeployFiles(TestContext context) {
            lock (_deploymentLock) {
                if (!_deployed) {
                    ...
                    TestSetupUtilities.GetTestFolders(@"Package\TestApp\Files", CommonTestData.TestFilesRelativePath, context.TestRunDirectory, out srcFilesFolder, out testFilesDir);
