...
// WARNING: this file was auto-generated then modified.
//
...
// The problem is that as soon as we try to use anything defined in the generated Run.cs, we get a compile error complaining it doesn't exist.

namespace Microsoft.VisualStudio.R.Package {
	
	
	internal partial class ConfigurationRun {
		...
		internal const string SchemaName = "ConfigurationRun";
		...
		/// <summary>Resets the REPL session when project is run.. (The "ResetReplOnRun" property).</summary>
		internal const string ResetReplOnRunProperty = "ResetReplOnRun";
		
		/// <summary>Relative path to the file to source when the project is run. (The "StartupFile" property).</summary>
		internal const string StartupFileProperty = "StartupFile";
		
		/// <summary>Command line arguments to pass to the startup file when project is run. (The "CommandLineArgs" property).</summary>
		internal const string CommandLineArgsProperty = "CommandLineArgs";
		...
		/// <summary>Initializes a new instance of the ConfigurationRun class.</summary>
		internal ConfigurationRun(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, string file, string itemType, string itemName) : 
		...
		/// <summary>Initializes a new instance of the ConfigurationRun class.</summary>
		internal ConfigurationRun(Microsoft.VisualStudio.ProjectSystem.Properties.IRule rule, Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject) : 
				this(rule) {
			if ((rule == null)) {
		...
		/// <summary>Initializes a new instance of the ConfigurationRun class.</summary>
		internal ConfigurationRun(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs, string context, Microsoft.VisualStudio.ProjectSystem.Properties.IProjectPropertiesContext propertyContext) : 
				this(configuredProject, catalogs, context, GetContextFile(propertyContext), propertyContext.ItemType, propertyContext.ItemName) {
		}
		
		/// <summary>Initializes a new instance of the ConfigurationRun class that assumes a project context (neither property sheet nor items).</summary>
		internal ConfigurationRun(Microsoft.VisualStudio.ProjectSystem.ConfiguredProject configuredProject, System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog> catalogs) : 
		...
		/// <summary>Resets the REPL session when project is run..</summary>
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty ResetReplOnRun {
			get {
				...
				Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(ResetReplOnRunProperty)));
				if (((property == null) 
							&& (this.GeneratedFallbackRule != null))) {
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(ResetReplOnRunProperty)));
				}
				return property;
			}
		}
		
		/// <summary>Relative path to the file to source when the project is run.</summary>
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty StartupFile {
			get {
				Microsoft.VisualStudio.ProjectSystem.Properties.IRule localRule = this.rule;
				if ((localRule == null)) {
					localRule = this.GeneratedFallbackRule;
				...
				Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(StartupFileProperty)));
				if (((property == null) 
							&& (this.GeneratedFallbackRule != null))) {
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(StartupFileProperty)));
				}
				return property;
			}
		}
		
		/// <summary>Command line arguments to pass to the startup file when project is run.</summary>
		internal Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty CommandLineArgs {
			get {
				Microsoft.VisualStudio.ProjectSystem.Properties.IRule localRule = this.rule;
				if ((localRule == null)) {
					localRule = this.GeneratedFallbackRule;
				...
				Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(CommandLineArgsProperty)));
				if (((property == null) 
							&& (this.GeneratedFallbackRule != null))) {
					localRule = this.GeneratedFallbackRule;
					property = ((Microsoft.VisualStudio.ProjectSystem.Properties.IEvaluatedProperty)(localRule.GetProperty(CommandLineArgsProperty)));
				}
				return property;
			}
		}
	...
	internal partial class ProjectProperties {
		...
		private static System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, ConfigurationRun> CreateConfigurationRunPropertiesDelegate = new System.Func<System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>>, object, ConfigurationRun>(CreateConfigurationRunProperties);
		
		private static ConfigurationRun CreateConfigurationRunProperties(System.Threading.Tasks.Task<System.Collections.Immutable.IImmutableDictionary<string, Microsoft.VisualStudio.ProjectSystem.Properties.IPropertyPagesCatalog>> namedCatalogs, object state) {
			ProjectProperties that = ((ProjectProperties)(state));
			return new ConfigurationRun(that.ConfiguredProject, namedCatalogs.Result, "Project", that.File, that.ItemType, that.ItemName);
		}
		
		/// <summary>Gets the strongly-typed property accessor used to get and set Run properties.</summary>
		internal System.Threading.Tasks.Task<ConfigurationRun> GetConfigurationRunPropertiesAsync() {
			...
			return namedCatalogsTask.ContinueWith(CreateConfigurationRunPropertiesDelegate, this, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskContinuationOptions.ExecuteSynchronously, System.Threading.Tasks.TaskScheduler.Default);
		}
	}
}
