...
namespace Microsoft.VisualStudio.R.Package.Options.R.Commands {
    public sealed class GoToEditorOptionsCommand : System.ComponentModel.Design.MenuCommand {
        private static IServiceContainer _services;

        public GoToEditorOptionsCommand(IServiceContainer services) :
            base(OnCommand, new System.ComponentModel.Design.CommandID(RGuidList.RCmdSetGuid, RPackageCommandId.icmdGoToREditorOptions)) {
