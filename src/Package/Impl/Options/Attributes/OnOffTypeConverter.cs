...
namespace Microsoft.VisualStudio.R.Package.Options.Attributes {
    internal sealed class OnOffTypeConverter : TypeConverter {
        ...
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType) 
            => destinationType == typeof(string) || destinationType == typeof(bool);
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context) => new StandardValuesCollection(new[] { true, false });
    }
}
