...
namespace Microsoft.VisualStudio.R.Package.ProjectSystem.PropertyPages.Settings {
    ...
    internal sealed class SettingPropertyDescriptor : PropertyDescriptor {
        private readonly IConfigurationSetting _setting;
        ...
        public override object GetValue(object component) => _setting.Value;
        public override void ResetValue(object component) { }
        public override void SetValue(object component, object value) {
            _setting.Value = value as string;
        }
        public override bool ShouldSerializeValue(object component) => false;

        protected override void FillAttributes(IList attributeList) {
            foreach(var a in _setting.Attributes) {
