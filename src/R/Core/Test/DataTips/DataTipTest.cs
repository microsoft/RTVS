...
namespace Microsoft.R.Core.Test.DataTips {
    ...
    public class DataTipTest {
        [CompositeTest]
        [Category.R.Debugger]
        [MemberData("Everywhere", "NULL")]
        [MemberData("Everywhere", "NA")]
        [MemberData("Everywhere", "42")]
        [MemberData("Everywhere", "42.24")]
        [MemberData("Everywhere", "'a'")]
        [MemberData("Everywhere", "\"a\"")]
        [MemberData("Everywhere", "`a`")]
        [MemberData("Everywhere", "a")]
        [MemberData("Everywhere", "a$b")]
        [MemberData("Everywhere", "a@b")]
        [MemberData("Everywhere", "a::b")]
        [MemberData("Everywhere", "a:::b")]
        [MemberData("EverywhereExcept", "a[b]", 2)]
        [MemberData("EverywhereExcept", "a[[b]]", 3)]
