...
namespace Microsoft.R.Editor.Test.Utility {
    ...
    internal static class QuickInfoSourceUtility {
        internal static Task<ITrackingSpan> AugmentQuickInfoSessionAsync(this QuickInfoSource quickInfoSource, AstRoot ast, ITextBuffer textBuffer, int position, IQuickInfoSession quickInfoSession, IList<object> quickInfoContent) {
