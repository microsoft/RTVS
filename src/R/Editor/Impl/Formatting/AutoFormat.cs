...
namespace Microsoft.R.Editor.Formatting {
    public class AutoFormat {
        ...
        public AutoFormat(IEditorView editorView, IEditorBuffer editorBuffer, IServiceContainer services) {
        ...
        public void HandleTyping(char typedChar, int position, IEditorBuffer editorBuffer = null) {
