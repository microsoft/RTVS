...
namespace Microsoft.Markdown.Editor.Classification.RMD
{
    ...
    /// </summary>
    internal sealed class RmdClassifier : TokenBasedClassifier<MarkdownTokenType, MarkdownToken>
    {
        public RmdClassifier(ITextBuffer textBuffer,
            ...
            base(textBuffer, new RmdTokenizer(), new MarkdownClassificationNameProvider())
        {
