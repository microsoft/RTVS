...
namespace Microsoft.R.Components.Test.Fakes.Undo {
    ...
    internal class UndoHistoryImpl : ITextUndoHistory {
        ...
        private UndoTransactionImpl _currentTransaction;
        private readonly Stack<ITextUndoTransaction> _undoStack;
        private readonly Stack<ITextUndoTransaction> _redoStack;
        private DelegatedUndoPrimitiveImpl _activeUndoOperationPrimitive;
        private TextUndoHistoryState _state;
        private PropertyCollection _properties;

        #endregion

        internal UndoHistoryRegistryImpl UndoHistoryRegistry { get; set; }
