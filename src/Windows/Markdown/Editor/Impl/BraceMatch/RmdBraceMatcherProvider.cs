...
namespace Microsoft.Markdown.Editor.BraceMatch {
    ...
    internal class RmdBraceMatcherProvider : IBraceMatcherProvider {
        public IBraceMatcher CreateBraceMatcher(ITextView textView, ITextBuffer textBuffer)
            => textBuffer.Properties.GetOrCreateSingletonProperty(() => new RmdBraceMatcher(textView, textBuffer));
    }
}
