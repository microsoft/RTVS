...
namespace Microsoft.R.Host.Client.Session {
    internal sealed class RSessionSimpleCallback : IRSessionCallback {
        ...
        public Task ShowErrorMessage(string message, CancellationToken cancellationToken = default(CancellationToken)) => _cb.ShowErrorMessage(message, cancellationToken);
