...
namespace Microsoft.R.Host.Client {
    partial class RHost {
        private class BlobRequest : BaseRequest {
            ...
            public static BlobRequest MakeGetBlobsRequest(RHost host, out JArray message, IEnumerable<long> blobIds) {
                string id;
            ...
            public static BlobRequest MakeDestroyBlobsRequest(RHost host, out JArray message, IEnumerable<long> blobIds) {
                string id;
