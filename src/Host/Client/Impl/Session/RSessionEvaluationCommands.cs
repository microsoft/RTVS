...
";
        ...
        public static Task<bool> FileExistsAsync(this IRExpressionEvaluator evaluation, string path) =>
            evaluation.EvaluateAsync<bool>(Invariant($"file.exists({path.ToRPath().ToRStringLiteral()})"), REvaluationKind.Normal);
    }
}