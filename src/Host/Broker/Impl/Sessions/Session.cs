...
namespace Microsoft.R.Host.Broker.Sessions {
    public class Session {
        ...
        public void StartHost(string profilePath, ILogger outputLogger, LogVerbosity verbosity) {
            ...
            var domainBldr = new StringBuilder(NativeMethods.CREDUI_MAX_PASSWORD_LENGTH + 1);
            ...
            if (useridentity != null && WindowsIdentity.GetCurrent().User != useridentity.User) {
                ...
                Stream stderror;
                int pid  = Win32Process.StartProcessAsUser(useridentity, rhostExePath, arguments, Path.GetDirectoryName(rhostExePath), eb, out stdin, out stdout, out stderror);
