...
namespace Odachi.AspNetCore.Authentication.Basic {
    /// <summary>
    /// Contains the options used by the <see cref="T:Odachi.AspNetCore.Authentication.Basic.BasicMiddleware" />.
    /// </summary>
    public sealed class BasicOptions : AuthenticationOptions, IOptions<BasicOptions> {
        public BasicOptions() {
        ...
        BasicOptions IOptions<BasicOptions>.Value => this;
    }
}