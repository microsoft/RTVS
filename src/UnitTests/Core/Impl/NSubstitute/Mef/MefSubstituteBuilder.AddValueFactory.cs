...
namespace Microsoft.UnitTests.Core.NSubstitute.Mef
{
    public partial class MefSubstituteBuilder
    {
        ...
        {
            ExportDefinition contractExport = CreateExportDefinition(contractName, type);
            ComposablePartDefinition partDefinition = CreatePartDefinition(ctorDefinition.ImportDefinitions, contractExport, type);
            FactoryReflectionComposablePart part = new FactoryReflectionComposablePart(partDefinition, factory);
